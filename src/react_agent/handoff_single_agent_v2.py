...
from common.tools import district_search, around_search, driving_route_handoff_single_v2, jump_to_around_search_agent, jump_to_path_planning_agent
from common.prompts import (MAIN_HANDOFF_SINGLE_V2_SYSTEM_PROMPT,
...
tools = [call_around_search_agent, call_path_planning_agent, jump_to_around_search_agent, jump_to_path_planning_agent]
